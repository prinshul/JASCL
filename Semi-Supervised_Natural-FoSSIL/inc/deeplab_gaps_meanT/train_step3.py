...
def image_paste_step3_IDD(step1_train, step1_val, train_gt_orig_files, val_gt_orig_files):   
    ...
    for i in range(0,len(train_gt_orig_files)):
        ...
        ## BDD Datadir
        img_name1 = step1_data_path+'train/images/'+step1_train[i].split("/")[-1].replace("gtFine_labelIds","leftImg8bit")
        lbl_name1 = step1_data_path+'train/labels/'+step1_train[i].split("/")[-1]
        
        
        ## IDD Datadir
        img_name2 = IDD_datadir+'train/images/'+train_gt_orig_files[i].split("/")[-1].replace("gtFine_labellevel3Ids","leftImg8bit")
        lbl_name2 = IDD_datadir+'train/labels/'+train_gt_orig_files[i].split("/")[-1]
    ...
    for i in range(0,len(val_gt_orig_files)):
        ...
        ## BDD Datadir
        img_name1 = step1_data_path+'train/images/'+step1_val[i].split("/")[-1].replace("gtFine_labelIds","leftImg8bit")
        lbl_name1 = step1_data_path+'train/labels/'+step1_val[i].split("/")[-1]
        
        
        ## IDD Datadir
        img_name2 = IDD_datadir+'train/images/'+val_gt_orig_files[i].split("/")[-1].replace("gtFine_labellevel3Ids","leftImg8bit")
        lbl_name2 = IDD_datadir+'train/labels/'+val_gt_orig_files[i].split("/")[-1]
...
def train(args, model, start_epoch, best_acc):
    ...
    curr_path_IDD = 'data_used/step3/'#image_paste_step3_IDD(gaps_train_gt_files[:idd_train_len], gaps_val_gt_files[:idd_val_len], step3_idd_rep_train_files,step3_idd_rep_val_files)
...
def save_prototypes(args, model):
    ...
    print(shots_datadir+'nshot_'+nshot+'/IDD_train_step3.pkl')
    
    dataset_train = IDD(IDD_datadir,step3_idd_rep_train_files, co_transform, 'train')
