...
def train(args, model, start_epoch, best_acc):
    ...
    if data_name == 'IDD':
        print('taking IDD')
        dataset_train = IDD(curr_path,train_gt_files, co_transform, 'train')
        dataset_val = IDD(curr_path,val_gt_files, co_transform_val, 'train')
...
def test(args, model):
    ...
    print("Total test files in Step 2 IDD val : ",len(IDD_test_step2))
    
    dataset_step2_test = torch.utils.data.ConcatDataset([dataset_test_step1,IDD_test_step2])
