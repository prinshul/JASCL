...
def train(args, model, model_old, start_epoch, best_acc):
    ...
    dataset_idd_rep_train = IDD(step3_datadir,step3_idd_rep_train_files, co_transform, 'train')
    dataset_idd_rep_val = IDD(step3_datadir,step3_idd_rep_val_files, co_transform_val, 'train')
...
def test(args, model):
    ...
    test_step3_all = torch.utils.data.ConcatDataset([BDD_test_step3, IDD_test_step3_rep])
