...
def train(args, model, model_old, start_epoch, best_acc):
    ...
    print("Total files in Step 3 IDD repeat train : ",len(dataset_step3_train))
    print("Total files in Step 3 IDD repeat val : ",len(dataset_step3_val))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num-classes-old', type=int, nargs="+", help='pass list with number of classes in previous task model, t-1 model',
                        required=False, default=[11,15])  # send [20] in IL-step2 (BDD), [20, 20] in IL-step3 (IDD)
