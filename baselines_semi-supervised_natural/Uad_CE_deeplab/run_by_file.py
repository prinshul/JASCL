...
all_cmds = [#'python train_step2.py --eval-type train --nshot 10 --num-epochs 2 --pseudo_label 10',
            #'python train_step2.py --eval-type test --nshot 10',
            #'python train_step3.py --eval-type train --nshot 10 --num-epochs 1 --pseudo_label 1',
            #'python train_step3.py --eval-type test --nshot 10',
            'python train_step4.py --eval-type train --nshot 10 --num-epochs 1 --pseudo_label 1',
