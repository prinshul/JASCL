...
def train(args, model, model_old, start_epoch, best_acc):
    ...
    unlabel_dir = 'data_used/step3/'
    nearest_neighbour_label(args, model, co_transform_val,IDD_datadir+"train/",step3_idd_unlabel_files,ft_list,label_list, unlabel_dir)
    torch.cuda.empty_cache()
    unlabeled_files = os.listdir(unlabel_dir+"train/labels/")
    dataset_unlabel = IDD(unlabel_dir,unlabeled_files, co_transform_val, 'train')
