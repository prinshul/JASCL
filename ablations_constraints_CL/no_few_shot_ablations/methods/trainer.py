...
class Trainer:
    ...
    def visualize_pred(self, labels, prediction, cur_epoch, cur_step):
        ...
        pass
        # sitk.WriteImage(label_arr, os.path.join('/hdd2/cil/ablation_datasets/dataset/prediction/ground_truth','{}_{}_{}.nii.gz'.format(cur_epoch, cur_step, self.opts.network_arch)))
        # sitk.WriteImage(prediction_arr, os.path.join('/hdd2/cil/ablation_datasets/dataset/prediction/predicted_mask','{}_{}_{}.nii.gz'.format(cur_epoch, cur_step, self.opts.network_arch)))
    ...
    def visualize_pred_test(self, labels, images, prediction, i_batch):
        ...
        pass
        # sitk.WriteImage(label_arr, os.path.join('/hdd2/cil/ablation_datasets/dataset/prediction/test/ground_truth','{}_{}.nii.gz'.format(i_batch, self.opts.network_arch)))
        # sitk.WriteImage(prediction_arr, os.path.join('/hdd2/cil/ablation_datasets/dataset/prediction/test/predicted_mask','{}_{}.nii.gz'.format(i_batch, self.opts.network_arch)))
        # sitk.WriteImage(image_arr, os.path.join('/hdd2/cil/ablation_datasets/dataset/prediction/test/images','{}_{}.nii.gz'.format(i_batch, self.opts.network_arch)))
