...
def main(opts):
    ...
    while cur_epoch < max_epoch and not opts.test:
        ...
        if cur_epoch % 50 == 0:
            ...
            print("ABLATION DEBUG")
            print(opts.num_classes)
            print(len(class_dice_test))
            ...
            with open('/hdd2/cil/no_few_shot_ablations/results/dice_step_{}_{}_test_{}_dynamic.txt'.format(task.step, cur_epoch, opts.network_arch), 'w') as file:
    ...
    with open('/hdd2/cil/no_few_shot_ablations/results/dice_step_{}_train_{}_dynamic.txt'.format(task.step, opts.network_arch), 'w') as file:
        for key, value in class_wise_dice_train_dict.items():
            file.write(f'{key}: {value}\n')
        
    with open('/hdd2/cil/no_few_shot_ablations/results/dice_step_{}_val_{}_dynamic.txt'.format(task.step, opts.network_arch), 'w') as file:
    ...
    with open('/hdd2/cil/no_few_shot_ablations/results/dice_step_{}_test_{}_dynamic.txt'.format(task.step, opts.network_arch), 'w') as file:
