...
# re-run ablation for just few shot
    parser.add_argument('--train_root_path', type=str,
                    default='/hdd2/cil/ablation_datasets_NO_CIL', help='root dir for train data')
    
    parser.add_argument('--val_root_path', type=str,
                        default='/hdd2/cil/ablation_datasets_NO_CIL', help='root dir for val data')
    parser.add_argument('--list_dir', type=str,
                        default='/hdd2/cil/ablation_datasets_NO_CIL/split', help='list dir')
