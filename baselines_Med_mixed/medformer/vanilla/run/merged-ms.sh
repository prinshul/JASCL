...
# medformer 
#exp --method FT --name FT --num_classes 11 --lr ${lr} ${gen_par} --step 0 --debug --batch_size ${bs}  
#exp --method FT --name FT --num_classes 19 --vanila --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 1 --input_mix novel --debug --nshot ${ns} --step_ckpt ${path}/FT_0_medformer_dynamic.pth
#exp --method FT --name FT --num_classes 25 --vanila --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 2 --input_mix both --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_1_medformer_dynamic.pth
#exp --method FT --name FT --num_classes 29 --vanila --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 3 --input_mix novel --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_2_medformer_dynamic.pth
exp --method FT --name FT --num_classes 36 --vanila --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 4 --input_mix novel --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_3_medformer_dynamic.pth
