...
#exp --method FT --name FT --num_classes 19 --vanila --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 1 --debug --input_mix novel --nshot ${ns} --step_ckpt ${path}/FT_0_newUNET_dynamic.pth
#exp --method FT --name FT --num_classes 25 --vanila --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 2 --debug --input_mix both --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_1_newUNET_dynamic.pth
#exp --method FT --name FT --num_classes 29 --vanila --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 3 --debug --input_mix novel --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_2_newUNET_dynamic.pth
exp --method FT --name FT --num_classes 36 --vanila --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 4 --debug --input_mix novel --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_3_newUNET_dynamic.pth
