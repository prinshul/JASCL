...
class DiceLoss(nn.Module):
    def __init__(self, weight=None, ignore_index=None, num_classes=3,dataset_index=None,**kwargs):
    ...
    def forward(self, predict, target, name, TEMPLATE, dataset_index):
...
class Multi_BCELoss(nn.Module):
    def __init__(self, ignore_index=None, num_classes=3,dataset_index=None, **kwargs):
    ...
    def forward(self, predict, target, name, TEMPLATE, dataset_index):
        ...
        for b in range(B):
            ...
            organ_list = TEMPLATE[dataset_index]
            for organ in organ_list:
                #if organ==255: ce_loss = self.criterion(predict[b, organ-1], target[b, organ-1])
                #else:
