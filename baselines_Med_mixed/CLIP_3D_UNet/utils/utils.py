...
ORGAN_NAME = ['Spleen', 'Right Kidney', 'Left Kidney', 'Gall Bladder', 'Esophagus', 
                ...
                'Kidney Tumor', 'Liver Tumor', 'Pancreas Tumor', 'Hepatic Vessel Tumor', 
                'Lung Tumor', 'Colon Tumor', 'Kidney Cyst',
                'inferior vena cava',
                'small bowel','Hip left','Hip right',
                'brats_1','brats_2','brats_3',
                'verse_c3','verse_c4','verse_t1','verse_t2']
...
def threshold_organ(data, organ=None, threshold=None):
    ...
    print(data.shape, threshold_list.shape)
