...
def main():
    ...
    ## dataset
    parser.add_argument('--data_root_path', default='med_3D/dataset/set2/set2_full/merged/dataset/images/test', help='data root path')
    parser.add_argument('--result_save_path', default='results/', help='path for save result')
