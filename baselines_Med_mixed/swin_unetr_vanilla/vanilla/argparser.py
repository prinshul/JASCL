...
def get_argparser():
    ...
    parser.add_argument('--train_root_path', type=str,
                    default="med_3D/dataset/set2/set2_full/merged", help='root dir for train data')
    

    parser.add_argument('--val_root_path', type=str,
                        default="med_3D/dataset/set2/set2_full/merged", help='root dir for val data')
    parser.add_argument('--list_dir', type=str,
                        default="med_3D/dataset/set2/set2_full/merged/split", help='list dir')
    ...
    parser.add_argument('--network_arch', type=str, default='swin_unetr', help='shape_prior, newUNET or SwinUNETR')
