...
class RandomGenerator(object):
    ...
    def __call__(self, sample):
        ...
        #print("Unique sample ",np.unique(label))
...
class MergedSegmentation(data.Dataset):
    ...
    def __init__(self, root, base_dir, split, num_classes, transform=None):
        ...
        step0_file = open(os.path.join(splits_dir, 'step0.txt')).readlines()
        ...
        if num_classes==11:
            ...
            if self.split == 'train' or self.split == 'val':
                ...
                for key in self.class_to_images_.keys():
                    # remove those samples from class_to_images
                    #if key>num_classes:
                        #break
                    #if key==0:
                        #continue
