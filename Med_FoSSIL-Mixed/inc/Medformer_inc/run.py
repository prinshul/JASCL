...
def main(opts):
    ...
    input_shape = torch.randn(1,1,128,160,96).cuda()
    flops = FlopCountAnalysis(model.model, input_shape)
    ...
    #return
    print("Network ", opts.network_arch)
    print("Image size ", opts.img_size)
    ...
    model.load_dict_full_model(checkpoint["model_state"]["model"], strict=False)
