...
class StochasticClassifier(nn.Module):
    ...
    def __init__(self, num_features, num_classes):
        ...
        torch.cuda.manual_seed(1024)
        self.mu = nn.Conv3d(num_features, num_classes, 1, bias=False)
        self.sigma = nn.Conv3d(num_features, num_classes, 1, bias=False)# each rotation have individual variance here
        self.temp = 10
...
class MedFormer(nn.Module):
    ...
    def __init__(self, 
        ...
        self.fc = StochasticClassifier(chan_num[7], num_classes)
