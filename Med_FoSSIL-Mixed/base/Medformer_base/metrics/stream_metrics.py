...
class StreamSegMetrics(_StreamMetrics):
    ...
    def confusion_matrix_to_fig(self, mode, norm_gt=True):
        ...
        if mode == 'train':
            if norm_gt:
                plt.savefig('/home/cil/Few-Shot-DCIL/save_fig/Confusion_Matrix_Train.png')
            else:
                plt.savefig('/home/cil/Few-Shot-DCIL/save_fig/Confusion_Matrix_Pred_Train.png')
        else:
            if norm_gt:
                plt.savefig('/home/cil/Few-Shot-DCIL/save_fig/Confusion_Matrix_Test.png')
            else:
                plt.savefig('/home/cil/Few-Shot-DCIL/save_fig/Confusion_Matrix_Pred_Test.png')
