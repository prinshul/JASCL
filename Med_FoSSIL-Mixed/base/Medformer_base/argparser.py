...
def get_argparser():
    ...
    parser.add_argument("--step", type=int, default=0,
                        help="Step (0 is base)")
    parser.add_argument("--task", type=str, default="15ss", choices=task.get_task_list(),
    ...
    parser.add_argument('--train_root_path', type=str,
                    default="<Path_to_Your_Root_Data>/Med_FoSSIL_Mixed_data/", help='root dir for train data')
    
    parser.add_argument('--val_root_path', type=str,
                        default="<Path_to_Your_Root_Data>/Med_FoSSIL_Mixed_data/", help='root dir for val data')
    parser.add_argument('--list_dir', type=str,
                        default="<Path_to_Your_Root_Data>/Med_FoSSIL_Mixed_data/split", help='list dir')
    ...
    parser.add_argument('--network_arch', type=str, default='medformer', help='shape_prior, newUNET or SwinUNETR')
