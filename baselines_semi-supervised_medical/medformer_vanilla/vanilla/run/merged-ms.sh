...
exp --method FT --name FT --num_classes 21 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 1 --input_mix novel --debug --nshot ${ns} --step_ckpt ${path}/FT_0_medformer_dynamic.pth
exp --method FT --name FT --num_classes 27 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 2 --input_mix novel --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_1_medformer_dynamic.pth
exp --method FT --name FT --num_classes 31 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 3 --input_mix novel --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_2_medformer_dynamic.pth
exp --method FT --name FT --num_classes 34 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 4 --input_mix novel --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_3_medformer_dynamic.pth
exp --method FT --name FT --num_classes 38 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 5 --input_mix novel --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_4_medformer_dynamic.pth
