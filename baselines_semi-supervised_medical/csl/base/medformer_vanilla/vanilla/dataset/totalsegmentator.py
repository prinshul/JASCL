...
class TotalSegmentatorSegmentation(data.Dataset):
...
class TotalSegmentatorDataset(FSSDataset):
    def make_dataset(self, root, base_dir, split, num_classes):
        full_voc = TotalSegmentatorSegmentation(root, base_dir, split, num_classes, transform=None)
        return full_voc