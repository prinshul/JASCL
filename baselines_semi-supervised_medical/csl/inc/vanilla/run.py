...
def main(opts):
    ...
    while cur_epoch <= max_epoch and not opts.test:
        ...
        if cur_epoch % 25 == 0 and cur_epoch>0:
            ...
            pseudo_train = model.pseudo_train(optimizer, dice_weight, ce_weight, cur_epoch=cur_epoch, train_loader=exemp_loader,
                                 labeled_loader=train_loader,metrics=train_metrics, print_int=opts.print_interval,
                                 n_iter=train_iterations, snapshot_path = snapshot_path)
