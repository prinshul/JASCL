...
# vanilla 
exp --method FT --name FT --num_classes 21 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 1 --debug --nshot ${ns} --step_ckpt ${path}/FT_0_newUNET_dynamic.pth --dist_warm_start --loss_kd 0.2 --ckd
exp --method FT --name FT --num_classes 27 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 2 --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_1_newUNET_dynamic.pth --dist_warm_start --loss_kd 0.2 --ckd
exp --method FT --name FT --num_classes 31 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 3 --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_2_newUNET_dynamic.pth --dist_warm_start --loss_kd 0.2 --ckd
exp --method FT --name FT --num_classes 34 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 4 --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_3_newUNET_dynamic.pth --dist_warm_start --loss_kd 0.2 --ckd
exp --method FT --name FT --num_classes 38 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 5 --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_4_newUNET_dynamic.pth --dist_warm_start --loss_kd 0.2 --ckd
