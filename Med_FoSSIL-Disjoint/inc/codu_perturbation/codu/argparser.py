...
def get_argparser():
    ...
    # Method
    parser.add_argument("--method", type=str, default='Experiment',
    ...
    parser.add_argument('--train_root_path', type=str,
                    default="<Path_to_Your_Root_Data>/Med_FoSSIL_Disjoint_data/", help='root dir for train data')
    
    parser.add_argument('--val_root_path', type=str,
                        default="<Path_to_Your_Root_Data>/Med_FoSSIL_Disjoint_data/", help='root dir for val data')
    parser.add_argument('--list_dir', type=str,
                        default="<Path_to_Your_Root_Data>/Med_FoSSIL_Disjoint_data/split", help='list dir')
    ...
    parser.add_argument('--img_size', type=int,
                        default=[128, 120, 120], help='input patch size of network input')                 # network input image size : 128
    ...
    parser.add_argument('--svf', action='store_true', default=False, help='svd decomposition of weights')
