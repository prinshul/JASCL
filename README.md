...
This is the official implementation of Continual Segmentation under Joint Nonstationarity accepted at the International Conference on Machine Learning (ICML) 2026.
...
The following table shows the number of incremental classes and their domains in each session for all [settings](https://github.com/prinshul/JASCL/blob/main/class_info.md) (SS stands for Semi-Supervised):
...
For baselines implementation, we have used the following repositories: 
