...
def get_argparser():
    ...
    parser.add_argument("--ssl_steps",default=100, type=int,
                        help='how many steps to run ssl')
    parser.add_argument('--temp', type=float, default=0.07,
                        help='temperature for loss function')
    parser.add_argument('--rot_weight', type=float, default=0.2,
                        help='weight for rotation')
    parser.add_argument('--tau_plus', type=float, default=0.1,
                        help='Positive class priorx')
