...
from networks.custom.swinunetr_partial_v3 import SwinUNETR as SwinUNETR_partial_v3
def make_model(opts, config_vit, n_classes):
    ...
    elif opts.network_arch == 'SwinUNETR_partial':
...
def get_old_model(opts, num_classes):
    if opts.network_arch == 'SwinUNETR_partial':
        model = SwinUNETR_partial_v3(
            img_size=(96, 96, 96),
            in_channels=1,
