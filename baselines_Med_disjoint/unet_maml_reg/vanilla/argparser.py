...
def get_argparser():
    ...
    parser.add_argument('--train_root_path', type=str,
                    default="med_3D/dataset/set1_extra/set1_full/merged/", help='root dir for train data')
    
    parser.add_argument('--val_root_path', type=str,
                        default="med_3D/dataset/set1_extra/set1_full/merged/", help='root dir for val data')
    parser.add_argument('--list_dir', type=str,
                        default="med_3D/dataset/set1_extra/set1_full/merged/split", help='list dir')
    ...
    parser.add_argument('--network_arch', type=str, default='newUNET', help='shape_prior, newUNET or SwinUNETR')
    ...
    parser.add_argument('--step_size', type=float,
                        default=0.4, help='step size for meta learning')
    parser.add_argument('--s_ratio', type=bool,
                        default=True, help='--s_ratio for meta learning regularization')
    parser.add_argument('--s_norm', type=bool,
                        default=True, help='--s_norm for meta learning regularization')                    
    parser.add_argument('--lbda1', type=float,
                        default=0.01, help='Hyperparameter for the SV ratio')
    parser.add_argument('--lbda2', type=float,
                        default=0.01, help='Hyperparameter for the norm')
