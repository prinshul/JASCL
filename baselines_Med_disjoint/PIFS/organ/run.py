...
def main(opts):
    ...
    while cur_epoch < max_epoch and not opts.test:
        ...
        if cur_epoch % 50 == 0:
            ...
            with open('cil/IFSS/organ/results/dice_step_{}_{}_test_{}_dynamic.txt'.format(task.step, cur_epoch, opts.network_arch), 'w') as file:
    ...
    with open('cil/IFSS/organ/results/dice_step_{}_train_{}_dynamic.txt'.format(task.step, opts.network_arch), 'w') as file:
        for key, value in class_wise_dice_train_dict.items():
            file.write(f'{key}: {value}\n')
        
    with open('cil/IFSS/organ/results/dice_step_{}_val_{}_dynamic.txt'.format(task.step, opts.network_arch), 'w') as file:
    ...
    with open('cil/IFSS/organ/results/dice_step_{}_test_{}_dynamic.txt'.format(task.step, opts.network_arch), 'w') as file:
