...
class Trainer:
    ...
    def visualize_pred(self, labels, prediction, cur_epoch, cur_step):
        ...
        sitk.WriteImage(label_arr, os.path.join('cil/IFSS/organ/data/merged/prediction/ground_truth','{}_{}_{}.nii.gz'.format(cur_epoch, cur_step, self.opts.network_arch)))
        sitk.WriteImage(prediction_arr, os.path.join('cil/IFSS/organ/data/merged/prediction/predicted_mask','{}_{}_{}.nii.gz'.format(cur_epoch, cur_step, self.opts.network_arch)))
    ...
    def visualize_pred_test(self, labels, images, prediction, i_batch):
        ...
        sitk.WriteImage(label_arr, os.path.join('cil/IFSS/organ/data/merged/prediction/test/ground_truth','{}_{}.nii.gz'.format(i_batch, self.opts.network_arch)))
        sitk.WriteImage(prediction_arr, os.path.join('cil/IFSS/organ/data/merged/prediction/test/predicted_mask','{}_{}.nii.gz'.format(i_batch, self.opts.network_arch)))
        sitk.WriteImage(image_arr, os.path.join('cil/IFSS/organ/data/merged/prediction/test/images','{}_{}.nii.gz'.format(i_batch, self.opts.network_arch)))
