...
def main(opts):
    ...
    checkpoint_path = f"checkpoints/step/{task_name}/FT_0_newUNET_dynamic.pth"
    ...
    model.load_dict_imprint(checkpoint["model_state"]["model"])
...
if __name__ == '__main__':
    ...
    print("\nStarting training of Step ",opts.step)
    main(opts)
