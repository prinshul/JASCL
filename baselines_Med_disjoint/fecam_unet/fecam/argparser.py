...
def get_argparser():
    ...
    parser.add_argument('--train_root_path', type=str,
                    default='med_3D/dataset/set1_orig/merged', help='root dir for train data')
    
    parser.add_argument('--val_root_path', type=str,
                        default='med_3D/dataset/set1_orig/merged', help='root dir for val data')
    parser.add_argument('--list_dir', type=str,
                        default='med_3D/dataset/set1_orig/merged/split', help='list dir')
