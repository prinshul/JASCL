...
alias label_samp="python label_samples.py"
...
# FSCIL SS
#exp --method FT --name FT --epochs 10 --max_epochs 150 --num_classes 21 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 1 --debug --nshot ${ns} --step_ckpt ${path}/FT_0_newUNET_dynamic.pth --dist_warm_start --loss_kd 0.4 --ckd
#label_samp --method FT --name FT --epochs 10 --num_classes 21 --lr ${lr} ${gen_par} --batch_size ${bs} --step 1
#exp --method FT --name FT --epochs 10 --max_epochs 200 --num_classes 21 --sample_exmp --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 1 --debug --nshot ${ns} --continue_ckpt --dist_warm_start --loss_kd 0.5 --ckd


#exp --method FT --name FT --epochs 10 --max_epochs 150 --num_classes 27 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 2 --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_1_newUNET_dynamic.pth --dist_warm_start --loss_kd 0.4 --ckd
#label_samp --method FT --name FT --epochs 10 --num_classes 27 --lr ${lr} ${gen_par} --batch_size ${bs} --step 2
exp --method FT --name FT --epochs 10 --max_epochs 200 --num_classes 27 --sample_exmp --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 2 --debug --nshot ${ns} --continue_ckpt --dist_warm_start --loss_kd 0.5 --ckd
