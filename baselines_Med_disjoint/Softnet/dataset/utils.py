...
class Subset(torch.utils.data.Dataset):
    ...
    def __init__(self, dataset, labels, indices, mask_label, transform=None, target_transform=None):
    ...
    def __getitem__(self, idx):
        ...
        # print("........", np.unique(sample['label']))
        if self.mask_label == 'train' or self.mask_label == 'val':
            target = self.mask_seg(sample['label'])
            sample['label'] = target
        # print(target.shape)
