...
def get_argparser():
    ...
    parser.add_argument('--train_root_path', type=str,
                    default="/cil/med_3D/dataset/set1_extra/set1_full/merged/", help='root dir for train data')
    
    parser.add_argument('--val_root_path', type=str,
                        default="/cil/med_3D/dataset/set1_extra/set1_full/merged/", help='root dir for val data')
    parser.add_argument('--list_dir', type=str,
                        default="/cil/med_3D/dataset/set1_extra/set1_full/merged/split", help='list dir')
