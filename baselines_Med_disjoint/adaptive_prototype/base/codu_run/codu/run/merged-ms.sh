...
#this is step0 test command
exp --method FT --name FT --lr ${lr} ${gen_par} --num_classes 16 --step 0 --debug --batch_size ${bs}  #--deeplab 'nonei
ns=5
is=0
...
#exp --load_weight_strategy --test --vanila --num_classes 21 --epochs 10 ${gen_par} ${inc_par} --batch_size ${bs} --step 1 --step_ckpt ${path}/FT_0_newUNET_dynamic.pth
#exp --load_weight_strategy --test --vanila --num_classes 27 --epochs 10 ${gen_par} ${inc_par} --batch_size ${bs} --step 2 --step_ckpt ${path}/F-s5-i0_1_newUNET_dynamic.pth
#exp --load_weight_strategy --test --vanila --num_classes 31 --epochs 10 ${gen_par} ${inc_par} --batch_size ${bs} --step 3 --step_ckpt ${path}/Experiment-s5-i0_2_newUNET_dynamic.pth
#exp --load_weight_strategy --test --vanila --num_classes 34 --epochs 10 ${gen_par} ${inc_par} --batch_size ${bs} --step 4 --step_ckpt ${path}/Experiment-s5-i0_3_newUNET_dynamic.pth
#exp --load_weight_strategy --test --vanila --num_classes 38 --epochs 10 ${gen_par} ${inc_par} --batch_size ${bs} --step 5 --step_ckpt ${path}/Experiment-s5-i0_4_newUNET_dynamic.pth
...
#exp --method FT --name FT --lr ${lr} ${gen_par} --test --num_classes 16 --step 0 --debug --batch_size ${bs}
