...
if __name__ == "__main__":
    data_rep_data_path = "/hdd2/cil/running_base/data_replay_Diffusion/data_replay/data/merged/dataset/"
    for folder in [data_rep_data_path+"/annotations/exemplar"]: #, "../dataset/annotations/test", "../dataset/annotations/val"]:
