...
def get_argparser():
    ...
    ## For Subspace regularizers
    parser.add_argument("--space_reg", default=0.0, type=float,
                        help='The subspace regularizer')
    parser.add_argument("--space_ft", default=0.0, type=float,  
                        help='The subspace regularizer lmbd for base and novel weights')
