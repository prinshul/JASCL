...
# Subspace reg 
#exp --method FT --name FT --epochs 10 --num_classes 16 --vanila --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 0 --debug --nshot ${ns} 
#exp --method FT --name FT --epochs 10 --num_classes 21 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 1 --debug --load_weight_strategy --nshot ${ns} --step_ckpt ${path}/FT_0_newUNET_dynamic.pth --space_reg 0.2 
exp --method FT --name FT --epochs 10 --num_classes 27 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 2 --debug --load_weight_strategy --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_1_newUNET_dynamic.pth --space_reg 0.2 --space_ft 0.1
