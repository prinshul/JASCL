...
ns=5
is=0
inc_par="--ishot ${is} --input_mix novel --val_interval 50 --ckpt_interval 5 --no_pooling --train_epoch 150 --max_epochs 200"

# vanilla 
exp --method FT --name FT --vanila --num_classes 21 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 1 --debug --nshot ${ns} --step_ckpt ${path}/FT_0_newUNET_dynamic.pth
exp --method FT --name FT --vanila --num_classes 27 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 2 --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_1_newUNET_dynamic.pth
exp --method FT --name FT --vanila --num_classes 31 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 3 --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_2_newUNET_dynamic.pth

#exp --method FT --name FT --vanila --num_classes 34 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 4 --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_3_newUNET_dynamic.pth
#exp --method FT --name FT --vanila --num_classes 38 --load_weight_strategy --epochs 10 --lr ${lr} ${gen_par} ${inc_par} --batch_size ${bs} --step 5 --debug --nshot ${ns} --step_ckpt ${path}/FT-s5-i0_4_newUNET_dynamic.pth
