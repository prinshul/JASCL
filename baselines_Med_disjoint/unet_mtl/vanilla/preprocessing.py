...
def main():
    data_tr_path = 'cil/totalsegmentator/dataset-01training/derivatives'
    data_val_path = 'cil/totalsegmentator/dataset-02validation/derivatives'
    # data_test_path = '/home/jupyter/MedSAM/VerSe2020/dataset-02test/derivatives'
    
    path_img_comb = 'cil/FSS_26_TS/data/combined/images'
    path_anno_comb = 'cil/FSS_26_TS/data/combined/annotations'
    
    dst_img_path_train = 'cil/FSS_26_TS/data/totalsegmentator/dataset/images/train'
    dst_img_path_test = 'cil/FSS_26_TS/data/totalsegmentator/dataset/images/val'

    dst_seg_path_train = 'cil/FSS_26_TS/data/totalsegmentator/dataset/annotations/train'
    dst_seg_path_test = 'cil/FSS_26_TS/data/totalsegmentator/dataset/annotations/val'

    dst_split_path = 'cil/FSS_26_TS/data/totalsegmentator/split'
    ...
    data_test_path = 'cil/totalsegmentator/dataset-03test/derivatives'
   
    dst_img_path_test_final = 'cil/FSS_26_TS/data/totalsegmentator/dataset/images/test'
    dst_seg_path_test_final = 'cil/FSS_26_TS/data/totalsegmentator/dataset/annotations/test'
