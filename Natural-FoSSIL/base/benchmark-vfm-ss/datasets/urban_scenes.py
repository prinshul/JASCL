...
class UrbanScenes(LightningDataModule):
    ...
    def setup(self, stage: Union[str, None] = None) -> LightningDataModule:
        ...
        print("Total train files step 1 : ",len(step1_train_files))
        ...
        print("Total test files step 0 : ",len(test_step0_data))
        print("Total test files step 1 : ",len(test_step1_data))
        ...
        print("train_dataloader completed :", s1)
        sys.stdout.flush()
        return self
